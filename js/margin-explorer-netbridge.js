...
// MEXP_resetNetBridge on every scope change). Same scope, refresh failed
// (transport) → the panel dims and names the scope it is showing. A determinate
// available:false is the answer for the scope and replaces the render: the panel
