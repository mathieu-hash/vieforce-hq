...
const marginExplorerHandler = require('./api/margin-explorer')
const marginPreviewHandler = require('./api/margin-preview')
const marginAiHandler = require('./api/margin-ai')
...
const cncCustomersHandler = require('./api/cnc/customers')
...
app.get('/api/margin-explorer', marginExplorerHandler)
app.get('/api/margin-preview', marginPreviewHandler)
app.post('/api/margin-ai', marginAiHandler)
...
app.get('/api/cnc/customers', cncCustomersHandler)
